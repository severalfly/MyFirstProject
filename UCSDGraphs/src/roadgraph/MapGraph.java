...
public class MapGraph {
										  ...
										  GeographicPoint goal, Consumer<GeographicPoint> nodeSearched)
	{
		...
		MapNode mapNode = this.pointNodeMap.get(start);
		...
		while (!queue.isEmpty())
		{
			...
			if (!visited.contains(curr.getLocation()))
			{
				...
				for (MapNode n : curr.getNeighbors())
				{
					...
					double currDis = curr.getDistance();
					double nDis = n.getDistance();
					if (currDis <= nDis)
					{
						n.setActualDistance(n.getActualDistance() + curr.getDistance());
						n.setDistance(curr.getDistance());
